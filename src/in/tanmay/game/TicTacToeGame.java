...
public class TicTacToeGame implements ActionListener
{
    ...
    TicTacToeGame()
    {
         jf = new JFrame("Tic Tac Toe Game By Tanmay Choudhary");
         jf.setSize(600,600);
    ...
    void whoWins()
    {
        if(win==true)
        {
             ...
             restartGame();
                ...
                {
                    JOptionPane.showMessageDialog(jf, "match draws");
                    restartGame();
                }
    }
    void restartGame()
    {
     int i=JOptionPane.showConfirmDialog(jf, "Do You Want To Restart The Game");
              ...
              else
              {
                  ...
                  buttonSetEnabbling(false);
              }
    }
    
    void buttonSetEnabbling(boolean b)
    {
          jb1.setEnabled(b);
                  jb2.setEnabled(b);
                  jb3.setEnabled(b);
